...
class sharedcomponent {
  void alertY(BuildContext context, String TTexty, String Texty,
      String imagepath, int check, int check2) {
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Text(check2 == 0 ? 'Add Coin' : "Let Me Know",
                              style: GoogleFonts.montserrat(
                                fontSize: 16.0,
                                color: Colors.white,
  ...
  Widget reusablecontainernewS(
      BuildContext context, Color texttcolor, String Textt) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
  ...
  Widget reusablecontainersignal(int check, BuildContext context,
      Color highlowcolor, String highorlow, String scalporhold) {
    return Stack(
      children: [
        Container(
          width: 354.w,
        ...
        Positioned(
            ...
            child: check == 0
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(4.0),
                      color: appcolors.targetsignalcolor,
                      border: Border.all(
                        width: 1.0,
                        color: appcolors.targetsignalcolor,
                      ),
            ...
            Expanded(
                ...
                child: Align(
                    ...
                    child: InkWell(
                        ...
                        child: middleText == 'Profile'
                            ? SizedBox(
                                height: 0.sp,
                                width: 0,
                              )
                            : Icon(
                                BitborgIcons.arrow_right,
                                size: 15.sp,
                              )))),
            Expanded(
              flex: 2,
  ...
  Widget reusabletargetconatiner() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              width: 2.0.sp, color: appcolors.onboardingcontainercolor)),
      child: ListView(
        children: <Widget>[
          SizedBox(
            height: 0.01.sh,
            ...
            children: <Widget>[
              ...
              Expanded(
                  ...
                  child: Text(
                    'Target 1',
                    style: GoogleFonts.montserrat(
                        color: appcolors.lighttextcolor, fontSize: 16.sp),
                  )),
              Expanded(
                  child: Padding(
                padding: const EdgeInsets.only(right: 8.0),
            ...
            children: <Widget>[
              ...
              Expanded(
                  ...
                  child: Text(
                    'Leverage 12',
                    style: GoogleFonts.montserrat(
                        color: appcolors.signalyellowishcolor, fontSize: 14.sp),
                  )),
              ...
              Expanded(
                ...
                child: Align(
                    ...
                    child: Text(
                      "Stop Loss 1.93 ",
                      style: GoogleFonts.montserrat(
                          color: appcolors.redsignalcolor,
                          fontWeight: FontWeight.w600),
                    )),
              ))
            ],
        ...
        children: <Widget>[
          Expanded(
              child: Align(
                  ...
                  child: Image.asset(
                    'assets/images/newsdetailimage.png',
                    width: 69.w,
                    height: 68.h,
