                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.only(top: 22.sp, left: 18),
                      width: 50,
                      height: 50,
                    ...
                    Container(
                      ...
                      width: 50,
                      height: 50,
                      padding: EdgeInsets.only(top: 22.sp, left: 18.sp),
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(4),
                          color: appcolors.onboardingcontainercolor,
                          border: Border.all(
                    ...
                    Container(
                      ...
                      child: TextField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              border: InputBorder.none),
                          onChanged: (value) {
                            var newvalue = controllerotp.text +
                                controllerotp1.text +
                                controllerotp2.text +
                                value.toString();
                            debugPrint(newvalue);
