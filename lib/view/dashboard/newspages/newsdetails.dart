...
class newsdetails extends StatefulWidget {
  ...
  const newsdetails({Key? key, required this.textColor, required this.textR})
      : super(key: key);

  @override
  State<newsdetails> createState() =>
      NewsdetailState(textColor, textR);
}
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                      ...
                      right: 0.sp,
                      child: Image.asset(
                        'assets/images/Gradientimage.png',
                        fit: BoxFit.cover,
                      )),
                  Positioned(
                    bottom: 20,
                      ...
                      child: Container(
                        ...
                        child: ListView(
                          children: <Widget>[
                            ...
                            Text(
                              "Bitcoin's ‘Upgrade for the Ages' Taproot is not",
                              style: GoogleFonts.montserrat(
                                  color: Colors.white,
