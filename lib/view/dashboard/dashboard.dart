          ...
          children: <Widget>[
            nameofpage == "Gems"
                ...
                : Expanded(
                    child: IconButton(
                      icon: Icon(icons),
                      color: nameofpage == 'Home' && state == 0
                          ? appcolors.buttoncolor
                          : nameofpage == 'News' && state == 1
                              ? appcolors.buttoncolor
                              : nameofpage == 'Signals' && state == 2
                                  ? appcolors.buttoncolor
                                  : nameofpage == 'Gems' && state == 3
                                      ? appcolors.buttoncolor
                                      : appcolors
                                          .unselectedbottomnaviagtioncolor,
                      //  tooltip: 'Home',
                      onPressed: () {},
                    ),
                  ),
                ...
                return Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (state == false) {
                        context
                            .read<dashboardcontainerCubit>()
                            .boolcheck(state: true);
                      } else {}
                    },
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            left: currentOrientation == Orientation.landscape
                                ? 355.sp
                                : 150.sp,
                            top: 10.sp,
                            child: GestureDetector(
          ...
          children: <Widget>[
            Expanded(
                child: GestureDetector(
                    ...
                    child: reusablebottomnavigationitems(
                        BitborgIcons.homebtmn, 'Home'))),
            Expanded(
                child: GestureDetector(
                    onTap: () {
